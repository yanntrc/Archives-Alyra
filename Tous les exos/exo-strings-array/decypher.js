...
if (0 < finalShift && finalShift < 14) {
    messageFinal = `Le message chiffré a été décallé de ${finalShift} lettres vers la droite.` // variable finalShift valable pour decallage droite jusqu'au chiffre 13
} else if (14 <= finalShift && finalShift < 25) {
    messageFinal = `Le message chiffré a été décallé de ${(-finalShift)+26} lettres vers la gauche.` //inversion de la variable finalShift pour prendre en compte decallage gauche.
} else {
    messageFinal = 'Le message n\'as pas besoin d\'être décodé.'
}
